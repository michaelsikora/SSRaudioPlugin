...
class BinauralRenderer : public SourceToOutput<BinauralRenderer, RendererBase>
{
  ...
  public:
    ...
    inline void load_reproduction_setup();
  ...
  private:
    ...
    inline void _load_hrtfs(const std::string& filename, size_t size);
    inline void _load_wav(const std::string& filename, size_t size);
#ifdef ENABLE_SOFA
